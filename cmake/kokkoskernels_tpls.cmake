...
MACRO(kokkoskernels_create_imported_tpl NAME)
  ...
  IF (NOT TPL_IMPORTED_NAME)
    message("no TPL_IMPORTED_NAME yet, let's created it:${TPL_IMPORTED_NAME}")
  ...
  ELSEIF (TPL_INTERFACE)
    ...
    ENDIF()
    IF(TPL_INCLUDES)
      message("INCLUDE DIRECTORIES ${TPL_INCLUDES} to ${NAME}")
    ...
    IF(TPL_COMPILE_OPTIONS)
      message("COMPILE OPTIONS ${TPL_COMPILE_OPTIONS} to ${NAME}")
      TARGET_COMPILE_OPTIONS(${NAME} INTERFACE ${TPL_COMPILE_OPTIONS})
    ENDIF()
    IF(TPL_LINK_OPTIONS)
      message("LINKS OPTIONS ${TPL_LINK_OPTIONS} to ${NAME}")
      TARGET_LINK_LIBRARIES(${NAME} INTERFACE ${TPL_LINK_OPTIONS})
    ENDIF()
  ELSE()
    message("kokkoskernels_create_imported_tpl ${TPL_IMPORTED_NAME}")
...
MACRO(kokkoskernels_find_imported NAME)
  ...
  FOREACH(LIB ${TPL_LIBRARIES})
    ...
    ELSE()
      ...
      BREAK()
    ENDIF()
    message("${NAME}_FOUND_LIBRARIES: ${${NAME}_FOUND_LIBRARIES}" )
  ...
  ENDIF()
  message("TPL_VARS_NEEDED ${TPL_VARS_NEEDED}")
  message("TPLS FIND_PACKAGE_HANDLE_STANDARD_ARGS: ${TPL_MODULE_NAME}")
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(${TPL_MODULE_NAME} REQUIRED_VARS ${TPL_VARS_NEEDED})
  message("TPLS FIND_PACKAGE_HANDLE_STANDARD_ARGS DONE and PACKAGE IS: ${TPL_MODULE_NAME} ${TPL_VARS_NEEDED}")
...
FUNCTION(kokkoskernels_link_tpl TARGET)
  ...
  ELSE()
    ...
    IF (KOKKOSKERNELS_ENABLE_TPL_${TPL})
      message("TARGET_LINK_LIBRARIES: ${TPL_IMPORTED_NAME} to ${TARGET}")
      IF (TPL_PUBLIC)
